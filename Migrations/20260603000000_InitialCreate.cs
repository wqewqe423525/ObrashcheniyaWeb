...
/// <inheritdoc />
/// <summary>
/// Начальная миграция. Создаёт структуру БД «УчетОбращений» в точности
/// по Приложению А диплома: пять таблиц с кириллическими именами,
/// автоинкрементными ключами, значениями по умолчанию и внешними ключами.
/// </summary>
public partial class InitialCreate : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ID_Гражданина = table.Column<int>(type: "int", nullable: false)
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ID_Сотрудника = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                ФИО = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                Пароль = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                Роль = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "пользователь")
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ID_Статуса = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ID_Обращения = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                ID_Гражданина = table.Column<int>(type: "int", nullable: false),
                ID_Типа = table.Column<int>(type: "int", nullable: false),
                ID_Статуса = table.Column<int>(type: "int", nullable: false),
                ID_Сотрудника = table.Column<int>(type: "int", nullable: false),
                Дата_поступления = table.Column<DateTime>(type: "date", nullable: false, defaultValueSql: "GETDATE()"),
                ...
                Результат = table.Column<string>(type: "nvarchar(max)", nullable: true)
            },
            constraints: table =>
            {
    ...
    {
        migrationBuilder.DropTable(name: "Обращения");
        migrationBuilder.DropTable(name: "Граждане");
        migrationBuilder.DropTable(name: "Сотрудники");
        migrationBuilder.DropTable(name: "Статусы");
        migrationBuilder.DropTable(name: "Типы_обращений");
    }
}
